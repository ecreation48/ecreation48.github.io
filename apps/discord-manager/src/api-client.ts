...
export interface DiscordChannelSyncPayload {guild?:{name?:string;owner_id?:string};channels:{id:string;name:string;type:number;parent_id?:string|null;user_limit?:number}[]}
